...
@section('content')
    <div>
        ...
        <div
            ...
            <img src="{{ asset('images/auth/coming-soon-object3.png')}}" alt="image" class="absolute right-0 top-0 h-[300px]" />
                ...
                <div
                    ...
                    <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                        ...
                        <div class="mt-24 hidden w-full max-w-[430px] lg:block">
                            <img src="{{ asset('images/auth/register.svg')}}" alt="Cover Image" class="w-full" />
                        </div>
                    </div>
                </div>
                <div
                    class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">                    <div class="w-full max-w-[440px] lg:mt-16">
                        <div class="mb-10">
