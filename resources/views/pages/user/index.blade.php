        ...
        <div class="pt-5">
            <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3 xl:grid-cols-4">
                    ...
                    <div class="mb-5">
                        ...
                        <ul class="m-auto mt-5 flex max-w-[160px] flex-col space-y-4 font-semibold text-white-dark">
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                {{ \Carbon\Carbon::parse(auth()->user()->created_at)->translatedFormat('d F Y') ?? 'Not Set' }}
                            </li>
                            <li class="flex items-center gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0">
                            ...
                            <li>
                                <a href="javascript:;" class="flex items-center gap-2">
                                    ...
                                    <span class="truncate text-primary">{{ auth()->user()->email ?? 'Not Set' }}</span></a>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                ...
                                <span class="whitespace-nowrap"
                                    dir="ltr">{{ auth()->user()->phone ?? 'Not Set' }}</span>
                            </li>
                        </ul>
                ...
                <div class="panel lg:col-span-2 xl:col-span-3">
                    <div class="mb-5">
                        <h5 class="text-lg font-semibold dark:text-white-light">Report Histori</h5>
                    </div>
                    <div class="mb-5">
