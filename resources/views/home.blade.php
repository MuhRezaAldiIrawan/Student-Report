                    ...
                    <div class="shadow-sm">
                        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                <a href="index.html" class="main-logo flex shrink-0 items-center">
                                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="{{asset('images/logo.svg')}}" alt="image" />
                                    <span
                            ...
                            >
                                ...
                                <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
                                    ...
                                    >
                                        <img
                                            :src="`{{asset('')}}images/flags/${$store.app.locale.toUpperCase()}.svg`"
                                            alt="image"
                                                    ...
                                                    <div class="grid place-content-center rounded">
                                                        <div class="relative h-12 w-12">
                                                            <img
                                                                ...
                                                                :src="`{{asset('')}}images/${notification.profile}`"
                                                                alt="image"
                                                            />
                                    ...
                                    <a href="javascript:;" class="group relative" @click="toggle()">
                                        <span
                                            ><img
                                                ...
                                                src="{{asset('')}}images/user-profile.jpeg"
                                                alt="image"
                                        /></span>
                                    </a>
                                    <ul
                                    ...
                                    >
                                        <li>
                                            <div class="flex items-center px-4 py-4">
                                                <div class="flex-none">
                                                    <img class="h-10 w-10 rounded-md object-cover" src="{{asset('')}}images/user-profile.jpeg" alt="image" />
                                                </div>
                                        ...
                                        <div class="mb-6 flex items-center justify-between">
                                            <div class="flex items-center rounded-full bg-black/50 p-1 font-semibold text-white ltr:pr-3 rtl:pl-3">
                                                <img
                                                    ...
                                                    src="{{asset('')}}images/profile-34.jpeg"
                                                    alt="image"
                                                />
                                                Alan Green
                                            </div>
                                                    ...
                                                    <td class="min-w-[150px] text-black dark:text-white">
                                                        <div class="flex items-center">
                                                            <img
                                                                ...
                                                                src="{{asset('')}}images/profile-6.jpeg"
                                                                alt="avatar"
                                                            />
                                                ...
                                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex items-center">
                                                            <img
                                                                class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="{{asset('')}}images/profile-7.jpeg"
                                                                alt="avatar"
                                                            />
                                                ...
                                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex items-center">
                                                            <img
                                                                class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="{{asset('')}}images/profile-8.jpeg"
                                                                alt="avatar"
                                                            />
                                                ...
                                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex items-center">
                                                            <img
                                                                class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="{{asset('')}}images/profile-9.jpeg"
                                                                alt="avatar"
                                                            />
                                                ...
                                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex items-center">
                                                            <img
                                                                class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="{{asset('')}}images/profile-10.jpeg"
                                                                alt="avatar"
                                                            />
                                                ...
                                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                                    <td class="min-w-[150px] text-black dark:text-white">
                                                        <div class="flex">
                                                            <img
                                                                class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="{{asset('')}}images/product-headphones.jpg"
                                                                alt="avatar"
                                                            />
                                                ...
                                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex">
                                                            <img
                                                                class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="{{asset('')}}images/product-shoes.jpg"
                                                                alt="avatar"
                                                            />
                                                ...
                                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex">
                                                            <img
                                                                class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="{{asset('')}}images/product-watch.jpg"
                                                                alt="avatar"
                                                            />
                                                ...
                                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex">
                                                            <img
                                                                class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="{{asset('')}}images/product-laptop.jpg"
                                                                alt="avatar"
                                                            />
                                                ...
                                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                                    <td class="text-black dark:text-white">
                                                        <div class="flex">
                                                            <img
                                                                class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                                src="{{asset('')}}images/product-camera.jpg"
                                                                alt="avatar"
                                                            />
